...
public class Test extends TestCase {
  public void testUniquifyingTransducer() {
    ...
    assertEquals("123", transducer.transduce(new StringCatIteration()).consume(Arrays.asList("1", "2", "2", "3")));
  }

  public void testMappingTransducer() {
    Transducer<Integer, String> transducer = new MappingTransducer<>(a -> a.toString());
    assertEquals("123", transducer.transduce(new StringCatIteration()).consume(Arrays.asList(1, 2, 3)));
  }
  ...
  public void testTakingTransducer() {
    ...
    assertEquals("123", transducer.transduce(new StringCatIteration()).consume(Arrays.asList(1, 2, 3, 4)));
  }
  ...
  public void testComposingTransducerOrder1() {
    ...
    assertEquals("12", transducer.transduce(new StringCatIteration()).consume(Arrays.asList("1", "2", "2", "3")));
  }
  ...
  public void testComposingTransducerOrder2() {
    ...
    assertEquals("123", transducer.transduce(new StringCatIteration()).consume(Arrays.asList("1", "2", "2", "3", "4")));
  }
  ...
  public void testFlatmappingTransducer() {
    ...
    assertEquals("2!4!", transducer.transduce(new StringCatIteration()).consume(Arrays.asList(1, 2, 3, 4, 5)));
  }
